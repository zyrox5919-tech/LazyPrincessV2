...
API_ID = int(environ.get('API_ID', '15554219'))
API_HASH = environ.get('API_HASH', 'f7e1e318df2bfa9ba39b14e34c43fb4c')
BOT_TOKEN = environ.get('BOT_TOKEN', "8687635506:AAE_9kztD3xGiWwRli5sMaNHt-bD_5GnhGE")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1463212098').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003909147235').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1484670284').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1004298873390')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://lucifer5a515:R1gqgzTBtuBqChPi@projectz.kk4kir3.mongodb.net/?appName=Projectz")
DATABASE_NAME = environ.get('DATABASE_NAME', "lucifer5a515")
